...
// attempts to apply. Each entry is declarative; the firefoxAdapter decides
// whether each protection can be applied — on Firefox none can be confined to
// the private session, so each is reported "unavailable".
//
