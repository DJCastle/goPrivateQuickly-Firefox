...
//
// No restoration bookkeeping is stored: Firefox never mutates global config
// (see firefoxAdapter), so nothing is ever written that could outlive the
// session, and there is nothing to restore after a restart.

import { firefoxAdapter } from "./firefoxAdapter.js";
