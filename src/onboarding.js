...
// Promise<boolean> on both Chromium and Firefox.
//
// Opening the settings page: a plain <a href="about:…"> link is blocked by the
// browser, but an extension may open it itself via chrome.tabs.create. We try
// that on the button click and only reveal the copy-paste fallback if it throws
// (some browsers refuse to open internal pages this way).
//   about:addons — can't deep-link further; the user clicks GPQ there.

const SETTINGS_URL = "about:addons";
const OPEN_BUTTON_TEXT = "Open Add-ons settings";
const TOGGLE_STEP_TEXT =
  "On the Add-ons page that opens, click \"Go Private Quickly,\" then scroll " +
  "down to about the middle and set \"Run in Private Windows\" to \"Allow.\"";
